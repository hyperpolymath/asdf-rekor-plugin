...
:url-repo: https://github.com/hyperpolymath/asdf-rekor-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-rekor-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-rekor-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-rekor-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Rekor] versions.
...
Rekor is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Rekor versions per project

|**Project Isolation**
|Pin Rekor per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Rekor version
...
=== Installing Rekor Versions

[source,bash]
----
asdf list all rekor
asdf install rekor latest
asdf install rekor 0.1.0
----
...
[source,bash]
----
asdf global rekor 0.1.0
asdf local rekor 0.1.0
asdf current rekor
rekor --version
----
...
* Ensure `rekor` is on PATH after installation.
* Verify the installed version with `rekor --version`.
